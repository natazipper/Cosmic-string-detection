...
from libstempo import libstempo
...
def add_cstring(
    ...
    :param mc: String tension mu
    :param dist: Luminosity distance to a string [Mpc]
    :param fgw: Frequency of GW [Hz]
    ...
    At = N.sin(2 * phase)
    Bt = N.cos(2 * phase)
    At_p = N.sin(2 * phase_p)
    Bt_p = N.cos(2 * phase_p)
